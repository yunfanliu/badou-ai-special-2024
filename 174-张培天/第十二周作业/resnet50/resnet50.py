...
def conv_block(input_tensor, kernel_size, filters, stage, block, strides=(2,2)):
    ...
    shortcut = Conv2D(filter3, (1,1), strides=strides, name=conv_name_base + 'l')(input_tensor)
...
def ResNet50(input_shape=[224,224,3], classes=1000):
    ...
    model.load_weights(r'E:\data\dabou\test\resnet50_weights_tf_dim_ordering_tf_kernels.h5')
