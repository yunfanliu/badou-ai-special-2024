...
class NeuralNetWork(object):
    ...
    def __init__(self, inputnodes, hiddennodes, outputnodes, learningrate):
        ...
        '''
        """
        numpy.random.uniform(low=0.0, high=1.0, size=None):用于从正态分布（也称为高斯分布）中抽取随机样本
        参数
    ...
    def train(self, inputs_list, targets_list):
        """
        根据输入的训练数据更新节点链路权重
        :param inputs_list: 输入集合
        :param targets_list: 输出集合
        :return:
        """
        '''
        ...
        print("转之前", numpy.array(inputs_list, ndmin=2))
        print("转之后", numpy.array(inputs_list, ndmin=2).T)
